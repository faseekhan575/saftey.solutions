      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center md:h-20 h-26">
          ...
          <div className="flex items-center absolute inset-x-0 justify-center pointer-events-none lg:pointer-events-auto lg:static">
            <NavLink to="/" className="flex items-center space-x-3 pointer-events-auto">
              <img
                ...
                alt="Flame Icon"
                className="md:h-20 md:w-12 h-12 w-8 object-contain"
              />
              <span className="font-extrabold text-gray-900">
                <span className="text-orange-600">SS</span>.SAFETY SOLUTIONS
              </span>
            </NavLink>
          </div>
          ...
          <div className="relative flex items-center space-x-4">
            ...
            {isLoggedIn ? (
              ...
              >
                <button className="p-2 rounded-full hover:bg-gray-100 transition text-orange-600">
                  <UserCheck size={24} />
                </button>

                {showLogout && (
                  <div className="absolute right-0 mt-2 w-44 bg-white border rounded-xl shadow-lg p-3 z-50">
            ...
            {/* Cart */}
            <button className="p-2 rounded-full hover:bg-gray-100 transition text-gray-700 hover:text-orange-600">
