...
import { Menu, X, User, ShoppingCart, UserCheck, LogOut, Trash2 } from "lucide-react";
...
function Nav() {
  ...
  // Sample cart items (replace with real cart context later)
  const [cartItems, setCartItems] = useState([
    { id: 1, title: "Safety Helmet Pro", price: 2500, quantity: 2 },
    { id: 2, title: "Fire Resistant Gloves", price: 1800, quantity: 1 },
  ]);
  ...
  const linkClass = ({ isActive }) =>
    `text-gray-700 font-medium transition hover:text-orange-600 ${isActive ? "text-orange-600" : ""}`;
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 bg-white shadow-md border-b border-gray-200">
          ...
          <div className="flex justify-between items-center md:h-20 h-16">
            ...
            <div className="flex items-center absolute inset-x-0 justify-center pointer-events-none lg:pointer-events-auto lg:static">
              ...
              >
                ...
                <span className="font-extrabold tracking-tight text-gray-900 text-center lg:text-left">
                  ...
                  <span className="hidden lg:inline lg:ml-1 text-2xl">SOLUTIONS</span>
                </span>
              </NavLink>
            </div>
            ...
            <div className="flex items-center space-x-3 sm:space-x-5">
              ...
              {isLoggedIn ? (
                ...
                <Link to="/signup" className="p-2 rounded-full hover:bg-gray-100 transition text-gray-700 hover:text-orange-600">
                  <User size={24} />
                </Link>
              )}
              ...
              <button
                ...
                className="relative p-2 rounded-full hover:bg-gray-100 transition text-gray-700 hover:text-orange-600"
              >
        ...
        {/* Logout Modal */}
        {showLogout && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 px-4" onClick={() => setShowLogout(false)}>
            <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-sm w-full relative" onClick={(e) => e.stopPropagation()}>
              <button onClick={() => setShowLogout(false)} className="absolute top-4 right-4 p-2 rounded-full hover:bg-gray-100 transition text-gray-500">
                <X size={24} />
              </button>
            ...
            <div className="flex flex-col h-full">
              {cartItems.length === 0 ? (
                ...
                <>
                  ...
                  {/* Total & Checkout */}
                  <div className="border-t border-gray-200 bg-gray-50 px-6 py-6 mt-auto">
